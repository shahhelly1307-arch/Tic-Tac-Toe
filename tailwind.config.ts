  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "neon-pulse": {
          "0%, 100%": { textShadow: "0 0 10px hsl(var(--primary)/0.8), 0 0 20px hsl(var(--primary)/0.5)" },
          "50%": { textShadow: "0 0 20px hsl(var(--primary)/1), 0 0 40px hsl(var(--primary)/0.8), 0 0 60px hsl(var(--primary)/0.4)" },
        },
        "shimmer": { "0%": { backgroundPosition: "-200% 0" }, "100%": { backgroundPosition: "200% 0" } },
        "float-y": { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-8px)" } },
        "glow-rotate": { "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } },
      },
      animation: {
